    ...
    return(
        <FlexContainer>
            ...
            <Form className="formRegister" onSubmit={handleSubmit(handleForm)}>
                ...
                <Block>
                    <Button className="btn-primary" type="Submit" variant="contained">Entrar</Button>
                </Block>
                <Cadastre className="text-login">Não tem cadastro? <Login>Cadastre-se</Login></Cadastre>
            </Form>
        </FlexContainer>
    )
}